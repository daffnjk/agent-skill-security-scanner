...
- Corrected the competition provenance: the open-source v / recall micro-loop 115 engine is the final Track B submission, not a post-contest successor.
...
- Open-source release of the final competition v rule engine with recall micro-rules through loop 115.
